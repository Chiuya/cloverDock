...
public class PlayerData
{
    ...
    public int level;
    public int[] specialCustomerRep = new int[5]; //0=little boy, 1=bride, 2= boxer, 3=ballerina, 4=samurai
    ...
    public PlayerData(Player player)
    {
        ...
        for (int i = 0; i < specialCustomerRep.Length; i++)
        {
            specialCustomerRep[i] = player.customerSOArray[i].repCurr;
        }
    }
}
